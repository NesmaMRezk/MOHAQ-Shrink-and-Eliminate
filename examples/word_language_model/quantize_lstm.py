...
# 
# Nesma: we need to add pretrained model and load test data
...
timitpath= '=/data/home/nesrez17/TIMIT/data/lisa/data/timit/raw/TIMIT'
...
batch_size = 20
eval_batch_size = 10
#Nesma commenting 3 lines for data preparation
...
rnn_model = torch.load('/data/home/nesrez17/pytorch-kaldi/exp/TIMIT_LSTM_fbank/exp_files/train_TIMIT_tr_ep00_ck2_architecture1.pth')
