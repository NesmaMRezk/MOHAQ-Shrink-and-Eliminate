            ...
            if retrain:
                ...
                if ii==3:
                    checkpoint_load = torch.load(
                        'exp/TIMIT_SRU_fbank_y/pretrained/exp_files/final_architecture' + str(ii) + '.pth.tar')
                else:
        ...
        if retrain:
            ...
            for net in nns_re.keys():
                   ...
                   #     print(nns_re[net].sru.rnn_lst[1].weight[0])
                        quantize_inline(nns_copy_1[net], nns_copy_2[net], 'SRU',weights_bits, projection_bits,checkpoint)
                #        print(nns_re[net].sru.rnn_lst[1].weight[0])
        ...
        for net in nns.keys():
            ...
            if retrain:
                if ii == 1:
                    ...
                    print(nns_re[net].sru.rnn_lst[1].weight[0])
                    quantize(output_folder, ii, 'SRU', weights_bits, projection_bits)
                elif ii == 2:
