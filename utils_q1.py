...
#from quantization.q_utils import symmetric_linear_quantization_scale_factor, linear_quantize_clamp, get_tensor_max_abs
...
def forward_model(
    fea_dict, lab_dict, arch_dict, model, nns, costs, inp, inp_out_dict, max_len, batch_size, to_do, forward_outs,mm
):
    ...
    for line in model:
        ...
        if operation == "compute":
            ...
            if len(inp_out_dict[inp2]) > 1:  # if it is an input feature
                ...
                outs_dict[out_name] = mm[inp1](inp_dnn)
