...
from core_t import read_next_chunk_into_shared_list_with_subprocess, extract_data_from_shared_list, convert_numpy_to_torch
import re
...
# --------FORWARD--------#
#Nesma: ep=23 from training
#rnn_model2 = torch.load('/data/home/nesrez17/pytorch-kaldi/exp/TIMIT_LSTM_fbank/exp_files_test/final_architecture1.pth.tar')
...
for forward_data in forward_data_lst:
    ...
    #    if not (os.path.exists(info_file)):
       ...
       # next_config_file = out_folder+"exp_files/forward_TIMIT_test_ep"+str(N_ep-1)+"_ck0.cfg"
        ...
        #Nesma: add else here
     #   else:
     #       print("info file found, Testing failed")
     #       sys.exit(0)
