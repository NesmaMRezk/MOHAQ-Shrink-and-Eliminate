...
class MyProblem(Problem):
 ...
 #           x[15]*=2
      ...
      #  else:
        ...
        #sheet_log.write("C" + str(self.count + 2), str(wer_f))
        #sheet_log.write("D" + str(self.count + 2), str(wer_t))
...
excel = xlsxwriter.Workbook('optimize_acc_mem_dnn6_3.xlsx')
excel_log = xlsxwriter.Workbook('log_acc__mem_dnn6_3.xlsx')
...
#for i in range(6):
 #   if i>-1:
#method = np.load("checkpoint_acc_mem_dnn_6_3.npy", allow_pickle=True).flatten()[0]
...
res = minimize(problem,
               ...
               verbose=True)
np.save("checkpoint_acc_mem_dnn_6_3", method)
excel_log.close()
plot = Scatter()
plot.add(res.F, color="red")
plot.save("pareto_acc_mem_dnn_6_3")
excel_init(stat)
